...
/* **************************************
* Build the detail view for 1 inventoryId view HTML
* ************************************ */
Util.buildInventoryDetail = async function(data){
  ...
  if(data.length > 0){
    ...
    detail += '<div class="detailsBlock">'
    detail += '<h2>' + vehicle.inv_make + ' ' + vehicle.inv_model + ' Details</h2>'
    detail += '<div class="listedDetails">'
 ...
 * ***************************** */
Util.adminOrEmployeeRequired = async (req, res, next) => {
